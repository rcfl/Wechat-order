    ...
    <el-card shadow="never" style="margin-top: 15px">
      ...
      <!--<div class="table-layout">-->
        <!--<el-row>-->
          ...
          <!--<el-col :span="4" class="table-cell-title">买家姓名</el-col>-->
          <!--<el-col :span="4" class="table-cell-title">用户联系方式</el-col>-->
        ...
        <!--<el-row>-->
          ...
          <!--<el-col :span="4" class="table-cell">{{order.buyerName}}</el-col>-->
      ...
      <div class="table-layout">
        <el-row>
          ...
          <el-col :span="6" class="table-cell-title">买家openid</el-col>
          <el-col :span="6" class="table-cell-title">收货地址</el-col>
        </el-row>
        <el-row>
          <el-col :span="6" class="table-cell">{{order.buyerName}}</el-col>
          <el-col :span="6" class="table-cell">{{order.buyerPhone}}</el-col>
          <el-col :span="6" class="table-cell">{{order.buyerOpenid}}</el-col>
          <el-col :span="6" class="table-cell">{{order.buyerAddress}}</el-col>
        </el-row>
      </div>
      <div style="margin-top: 20px">
        <svg-icon icon-class="marker" style="color: #606266"></svg-icon>
      ...
      <el-table
        ...
        <el-table-column label="商品图片" width="120" align="center">
          <template slot-scope="scope">
            <img :src="scope.row.productPrice" style="height: 80px">
          </template>
        </el-table-column>
    ...
    <el-dialog title="修改收货人信息"
      ...
      <el-form :model="receiverInfo"
        ...
        <el-form-item label="收货人姓名：">
          <el-input v-model="receiverInfo.buyerName" style="width: 200px"></el-input>
        </el-form-item>
        ...
        <el-form-item label="详细地址：">
          <el-input v-model="receiverInfo.buyerAddress" type="textarea" rows="3">
          </el-input>
        </el-form-item>
      </el-form>
...
<script>
  ...
  export default {
    ...
    created() {
      this.orderId = this.list = this.$route.query.orderId;
      // alert(this.orderId)
      getOrderDetail(this.orderId).then(response => {
        this.order = response.data;

        this.orerDetailList = this.order.orderDetailList;
      });
    },
    filters: {
      formatNull(value) {
    ...
    methods: {
      ...
      showUpdateReceiverDialog(){
        ...
        this.receiverInfo={
          ...
          receiverDetailAddress:this.order.buyerAddress,
